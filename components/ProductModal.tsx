        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onFocus={(e) => {
                const borderColor = errors.name ? '#fca5a5' : settings?.primaryColor || '#3b82f6';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onFocus={(e) => {
                  const borderColor = errors.price ? '#fca5a5' : (settings?.primaryColor || '#3b82f6');
                  e.currentTarget.style.borderColor = borderColor;
            ...
            <div>
              ...
              <input
                ...
                onFocus={(e) => {
                  const borderColor = errors.stock ? '#fca5a5' : (settings?.primaryColor || '#3b82f6');
                  e.currentTarget.style.borderColor = borderColor;
                  e.currentTarget.style.boxShadow = `0 0 0 2px ${borderColor}30`;
                }}
                onBlur={(e) => {
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                onFocus={(e) => {
                  const borderColor = errors.sku ? '#fca5a5' : settings?.primaryColor || '#3b82f6';
                  e.currentTarget.style.borderColor = borderColor;
          ...
          <div>
            ...
            <input
              ...
              onFocus={(e) => {
                const borderColor = errors.barcode ? '#fca5a5' : (settings?.primaryColor || '#3b82f6');
                e.currentTarget.style.borderColor = borderColor;
                e.currentTarget.style.boxShadow = `0 0 0 2px ${borderColor}30`;
              }}
              onBlur={(e) => {
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                onFocus={(e) => {
                  const borderColor = errors.image ? '#fca5a5' : (settings?.primaryColor || '#3b82f6');
                  e.currentTarget.style.borderColor = borderColor;
                  e.currentTarget.style.boxShadow = `0 0 0 2px ${borderColor}30`;
                }}
                onBlur={(e) => {
          ...
          <div className="relative">
            ...
            <div ref={categoryInputRef} className="relative">
              <input
                ...
                onFocusCapture={(e) => {
                  const borderColor = errors.category ? '#fca5a5' : settings?.primaryColor || '#3b82f6';
                  e.currentTarget.style.borderColor = borderColor;
          ...
          {(businessTypeConfig as any)?.defaultFeatures?.enableInventory !== false && (
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                style={{ accentColor: settings?.primaryColor || '#3b82f6' }}
              />
                  ...
                  {pickerFiles
                    ...
                    .map(file => (
                      <button
                        ...
                        style={formData.image === file.url ? { borderColor: settings?.primaryColor || '#3b82f6' } : {}}
                      >
                        <Image

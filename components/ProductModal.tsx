        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 text-base border rounded-md focus:ring-2 focus:ring-blue-500 ${
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className={`flex-1 px-3 py-2.5 text-base border rounded-md focus:ring-2 focus:ring-blue-500 ${

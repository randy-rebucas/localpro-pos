...
/**
 * Staff double-booking check: find any active (pending/confirmed) booking
 * for the same staff (or, if staffId is omitted, any active booking at all)
 * whose time range overlaps [startTime, endTime), optionally excluding a
 * given booking id (for updates).
 */

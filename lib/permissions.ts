...
export const PERMISSIONS: PermissionDef[] = [
  ...
  { key: 'suppliers.manage', label: 'Suppliers', section: 'catalog', defaultMinRole: 'manager' },
  { key: 'purchase_orders.manage', label: 'Purchase Orders', section: 'catalog', defaultMinRole: 'manager' },
  { key: 'purchase_orders.view', label: 'View Purchase Orders', section: 'catalog', defaultMinRole: 'cashier' },
  { key: 'stock_transfers.manage', label: 'Stock Transfers', section: 'catalog', defaultMinRole: 'manager' },
  { key: 'stock_transfers.view', label: 'View Stock Transfers', section: 'catalog', defaultMinRole: 'cashier' },
  ...
  { key: 'ledger.manage', label: 'Accounting Ledger', section: 'sales', defaultMinRole: 'manager' },
  { key: 'ledger.view', label: 'View Accounting Ledger', section: 'sales', defaultMinRole: 'manager' },
  ...
  { key: 'customer_groups.manage', label: 'Customer Groups', section: 'customers', defaultMinRole: 'manager' },
  ...
  { key: 'delivery.manage', label: 'Delivery & Riders', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'delivery.view', label: 'View Deliveries', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'work_orders.manage', label: 'Job / Work Orders', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'work_orders.view', label: 'View Work Orders', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'deposits.manage', label: 'Deposits', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'deposits.view', label: 'View Deposits', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'deposits.refund', label: 'Refund/Forfeit Deposits', section: 'operations', defaultMinRole: 'manager' },
  { key: 'work_order_time.manage', label: 'Job Time Tracking', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'laundry_orders.manage', label: 'Laundry Orders', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'laundry_orders.view', label: 'View Laundry Orders', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'kitchen_display.manage', label: 'Kitchen Display', section: 'operations', defaultMinRole: 'cashier' },
  { key: 'kitchen_display.view', label: 'View Kitchen Display', section: 'operations', defaultMinRole: 'cashier' },
  ...
  { key: 'integrations.manage', label: 'E-commerce Integrations (also governs Channel Orders)', section: 'operations', defaultMinRole: 'manager' },

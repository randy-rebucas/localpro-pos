...
export default function Dashboard() {
  ...
  const [selectedCustomer, setSelectedCustomer] = useState<{ _id: string; firstName: string; lastName: string; email?: string; phone?: string; totalSpent?: number; lastPurchaseDate?: string; loyaltyPointsBalance?: number; creditBalance?: number } | null>(null);

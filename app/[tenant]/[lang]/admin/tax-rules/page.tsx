      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="mb-6 sm:mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2">
            {(dict?.admin as Record<string, unknown>)?.taxRules as string || 'Tax Rules'}
          </h1>
          <p className="text-gray-600">
            {(dict?.admin as Record<string, unknown>)?.taxRulesSubtitle as string || 'Configure multiple tax rates based on region, product type, or category. Set priorities to control which rules apply.'}
          </p>
        </div>
